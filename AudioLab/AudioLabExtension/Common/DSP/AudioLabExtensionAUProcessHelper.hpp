//
//  AudioLabExtensionAUProcessHelper.hpp
//  AudioLabExtension
//
...
#include "AudioLabExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(AudioLabExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    AudioLabExtensionDSPKernel& mKernel;
